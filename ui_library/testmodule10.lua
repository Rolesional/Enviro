...
local Library do
	...
	local Themes = {
		["Preset"] = {
			...
			["Accent"] = FromRGB(235, 76, 48) -- MemeSense Red
		}
	}
	...
	local Components = { } do
		...
		Components.WindowPage = function(self, Data)
			...
			local Items = { } do
				...
				})  Items["Inactive"]:AddToTheme({BackgroundColor3 = "Hovered Element"})
		...
		Components.Toggle = function(self, Data)
			...
			function Toggle:Set(Value)
				...
				if Toggle.Value then
					...
					Items["Check"]:Tween(TweenInfo.new(Library.Tween.Time), {ImageTransparency = 0})
				else
					Items["Indicator"]:ChangeItemTheme({BackgroundColor3 = "Element", BorderColor3 = "Border"})
					Items["Indicator"]:Tween(nil, {BackgroundColor3 = Library.Theme.Element})
					Items["Check"]:Tween(TweenInfo.new(Library.Tween.Time), {ImageTransparency = 1})
				end
		...
		Components.Dropdown = function(self, Data)
			...
			local Items = { } do
				...
				Items["RealDropdown"] = Instances:Create("TextButton", {
					...
					BorderSizePixel = 1,
					BackgroundColor3 = FromRGB(35, 35, 35)
				})  Items["RealDropdown"]:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Border"})
		...
		Components.Textbox = function(self, Data)
			...
			local Items = { } do
				...
				Items["Background"] = Instances:Create("Frame", {
					...
					BorderSizePixel = 1,
					BackgroundColor3 = FromRGB(35, 35, 35)
				})  Items["Background"]:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Border"})
	...
	Library.KeybindList = function(self)
		...
		local Items = { } do
			Items["KeybindList"] = Instances:Create("Frame", {
				...
				BorderColor3 = FromRGB(12, 12, 12),
				-- 1. Fixed width to prevent the "full screen" bug
	...
	Library.Window = function(self, Data)
		...
		local Items = Components:Window({
			...
			Items["Header"] = Instances:Create("Frame", {
				Parent = Items["Window"].Instance,
				Name = "\0",
				Position = UDim2New(0, 180, 0, 1),
				Size = UDim2New(1, -180, 0, 45),
				BackgroundTransparency = 1,
				BorderSizePixel = 0,
			})
	...
	Library.Loader = function(self, Data)
		...
		local function MakeCard(Game)
			...
			-- Card height: 8 top + 12 name + 4 gap + 10 status + 4 gap + 10 features + 4 gap + 10 executors + 8 bottom = 70
			...
			-- Content area starts at x=8, right buttons take 80px
